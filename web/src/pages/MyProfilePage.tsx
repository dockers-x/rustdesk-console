  ...
  return (
    <div className="space-y-3 text-sm leading-6">
      {rows.map(({ line, index }) => {
        ...
        if (line.startsWith("- ")) {
          return (
            <p key={index} className="flex gap-2 text-kumo-default">
      ...
      if (link && isSafeLink(link[2])) {
        parts.push(
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="font-medium text-kumo-brand underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-kumo-brand"
          >
            {link[1]}
          </a>,
        );
